---
title: "Codex Open Source Fund: Free ChatGPT Pro and API Credits for Maintainers"
date: 2026-03-31
tags: [open-source, oss-fund, chatgpt-pro, api-credits, codex-security, community]
...
|---------|-----|-----------|
| **Codex for Open Source** | [openai.com/form/codex-for-oss](https://openai.com/form/codex-for-oss/) | ChatGPT Pro + Codex Security. For individual maintainers. |
| **Codex Open Source Fund** | [openai.com/form/codex-open-source-fund](https://openai.com/form/codex-open-source-fund/) | Up to $25K API credits. For projects integrating Codex/OpenAI models in workflows. |
...
1. **Codex for OSS (Pro + Security):** https://openai.com/form/codex-for-oss/
2. **Open Source Fund (API credits):** https://openai.com/form/codex-open-source-fund/
...
- [Fund docs (github.com/openai/codex)](https://github.com/openai/codex/blob/main/docs/open-source-fund.md)
- [Announcement coverage — winbuzzer.com](https://winbuzzer.com/2026/03/09/openai-codex-open-source-maintainers-free-chatgpt-pro-xcxwbn/) — March 9, 2026
- [OpenAI Empowers Open Source — opentools.ai](https://opentools.ai/news/openai-empowers-open-source-with-six-months-of-free-chatgpt-pro-and-codex-access-for-maintainers)
