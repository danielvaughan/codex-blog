...
*Diagram: A flowchart illustrating: [new task.*
...
---
*This article is part of the [Codex CLI Knowledge Base](https://github.com/danielvaughan/codex-resources). Follow on Substack for weekly Codex CLI insights.*
