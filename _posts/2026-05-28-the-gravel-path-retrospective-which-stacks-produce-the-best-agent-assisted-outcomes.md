...
*Updated 17 September 2026: added Murphy-Hill, Butler and Savelieva's enterprise field study (arXiv:2607.01418, Microsoft, July 2026) — the first large-scale measurement of command-line coding agent adoption at enterprise scale, showing 24 per cent more merged PRs but with a critical cost caveat: token spend drove Microsoft to discontinue Claude Code licences for most engineers, confirming that harness cost governance is not optional at enterprise scale. Added "Harness or Model?" (arXiv:2609.11987, September 2026) — a contamination-controlled study finding no clear average advantage for vendor-native harness-model pairings, with the harness effect varying sharply by task type and the neutral harness consistently more cost-efficient; the findings validate the Gravel Path's focus on minimal, cost-efficient artefacts over vendor-native feature sets.*
...
[^microsoft-cli-study]: Murphy-Hill, E., Butler, J. and Savelieva, A. "Adoption and Impact of Command-Line AI Coding Agents: A Study of Microsoft's Early 2026 Rollout of Claude Code and GitHub Copilot CLI." arXiv:2607.01418, 1 July 2026. Field study of tens of thousands of Microsoft engineers over a four-month observation window. Adopters merged ~24% more pull requests than they would have otherwise; the productivity signal was sustained and showed a dose-response curve. Adoption spread primarily through social networks, not formal rollout channels. The paper's key cost caveat: token spend "can run into millions of dollars annually," with Microsoft subsequently discontinuing Claude Code licences for most engineers — the first large-scale documented case of enterprise AI tool rollback driven by cost rather than capability. Retention correlated more strongly with engineers' existing coding activity than with demographics. https://arxiv.org/abs/2607.01418

[^harness-or-model]: "Harness or Model? Isolating the Harness Effect in Agentic Coding with a Contamination-Controlled Private Suite." arXiv:2609.11987, 8 September 2026. Compared Claude Opus 4.8 and GPT-5.5 under native vs neutral harnesses using 256 contamination-controlled tasks (repository problems + post-cutoff contest problems). Key findings: no clear average advantage for vendor-native pairings (−1.25 pp Claude, +1.25 pp GPT-5.5); the harness effect is task-type-dependent (−9.0 pp on repository tasks, +23.7 pp on contest tasks for the native harness, p=0.003 — but the partition was post-hoc and requires designed replication); neutral harness was 1.2–1.6× more cost-efficient per solved task. Implication: the harness effect is most reliable on cost reduction and real-world repository tasks, exactly the profile the Gravel Path's four artefacts are designed for. https://arxiv.org/abs/2609.11987
