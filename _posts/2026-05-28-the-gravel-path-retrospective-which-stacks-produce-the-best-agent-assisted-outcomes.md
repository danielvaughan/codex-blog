...
Since the Gravel Path parent article was published, harness engineering has crystallised from a niche practice into what TechTimes called "the fourth paradigm of AI engineering" — after prompting, fine-tuning, and RAG[^fourth-paradigm]. Eight developments confirm the series' central thesis: the harness, not the model, is the primary lever.
