...
A 2026 Equixly security assessment found 43% of tested MCP implementations had command injection vulnerabilities [^12]. The MCP 2.4 specification now mandates tool sandboxing and runtime instrumentation for external function calls [^12]. Your test suite should include:
