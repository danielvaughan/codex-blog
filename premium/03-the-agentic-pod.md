...
That logic becomes sharper once agents handle much of the execution. OpenAI's own Codex Day presentation revealed a case study that makes the point bluntly: a team of three engineers spent five months building a product that is now in production serving millions of users. The kicker — those three engineers wrote zero lines of code themselves. Codex wrote millions of lines across 500 NPM packages, with some agent tasks running continuously for 36 hours. The humans focused on architecture, constraints, and code review[^11].
...
[^11]: OpenAI Codex Day keynote presentation, April 2026. The speaker described an internal OpenAI team of three engineers who built a production product serving millions of users over five months, writing zero lines of code themselves. Codex generated millions of lines across 500 NPM packages, with individual agent tasks running up to 36 hours. The speaker framed the humans' role as "focusing on architecture, constraints, and reviewing code." Also presented: 400% enterprise adoption growth since January 2026, 3 million+ weekly active users, and case studies from Cisco (20% faster builds, 1,500 engineering hours saved, 10–15x faster defect remediation) and Datadog (1,500 engineers daily, 22% of past defects flaggable faster). Transcript available at `notes/transcripts/codex-day.md`.
